import 'models/competition_leaguegroup_model.dart';
import 'package:flutter/material.dart';
import 'package:invovision_s_application1/core/app_export.dart';
import 'package:invovision_s_application1/widgets/custom_elevated_button.dart';
import 'provider/competition_leaguegroup_provider.dart';

// ignore_for_file: must_be_immutable
class CompetitionLeaguegroupPage extends StatefulWidget {
  const CompetitionLeaguegroupPage({Key? key})
      : super(
          key: key,
        );

  @override
  CompetitionLeaguegroupPageState createState() =>
      CompetitionLeaguegroupPageState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompetitionLeaguegroupProvider(),
      child: CompetitionLeaguegroupPage(),
    );
  }
}

class CompetitionLeaguegroupPageState extends State<CompetitionLeaguegroupPage>
    with AutomaticKeepAliveClientMixin<CompetitionLeaguegroupPage> {
  @override
