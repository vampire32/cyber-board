import 'models/competition_challenge_two_model.dart';
import 'package:flutter/material.dart';
import 'package:invovision_s_application1/core/app_export.dart';
import 'package:invovision_s_application1/widgets/custom_elevated_button.dart';
import 'provider/competition_challenge_two_provider.dart';

// ignore_for_file: must_be_immutable
class CompetitionChallengeTwoPage extends StatefulWidget {
  const CompetitionChallengeTwoPage({Key? key})
      : super(
          key: key,
        );

  @override
  CompetitionChallengeTwoPageState createState() =>
      CompetitionChallengeTwoPageState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompetitionChallengeTwoProvider(),
      child: CompetitionChallengeTwoPage(),
    );
  }
}

class CompetitionChallengeTwoPageState
    extends State<CompetitionChallengeTwoPage>
    with AutomaticKeepAliveClientMixin<CompetitionChallengeTwoPage> {
  @override
