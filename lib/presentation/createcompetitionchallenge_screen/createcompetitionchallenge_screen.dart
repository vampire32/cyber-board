import '../createcompetitionchallenge_screen/widgets/fifteen1_item_widget.dart';
import '../createcompetitionchallenge_screen/widgets/sixtyeight_item_widget.dart';
import 'models/createcompetitionchallenge_model.dart';
...
import 'provider/createcompetitionchallenge_provider.dart';

class CreatecompetitionchallengeScreen extends StatefulWidget {
  const CreatecompetitionchallengeScreen({Key? key})
      : super(
          key: key,
        );

  @override
  CreatecompetitionchallengeScreenState createState() =>
      CreatecompetitionchallengeScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CreatecompetitionchallengeProvider(),
      child: CreatecompetitionchallengeScreen(),
    );
  }
}

class CreatecompetitionchallengeScreenState
    extends State<CreatecompetitionchallengeScreen> {
  ...
  Widget _buildFifteen(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Consumer<CreatecompetitionchallengeProvider>(
          builder: (context, provider, child) {
            return ListView.separated(
              ...
              itemCount: provider
                  .createcompetitionchallengeModelObj.fifteen1ItemList.length,
              itemBuilder: (context, index) {
                Fifteen1ItemModel model = provider
                    .createcompetitionchallengeModelObj.fifteen1ItemList[index];
                return Fifteen1ItemWidget(
                  model,
                );
              },
            );
  ...
  Widget _buildName(BuildContext context) {
    return Expanded(
      child: Padding(
        ...
        child: Selector<CreatecompetitionchallengeProvider,
  ...
  Widget _buildEnterprizes(BuildContext context) {
    return Selector<CreatecompetitionchallengeProvider, TextEditingController?>(
      selector: (
        context,
        provider,
      ) =>
        ...
        builder: (context, provider, child) {
          return Wrap(
            ...
            children: List<Widget>.generate(
              provider
                  .createcompetitionchallengeModelObj.sixtyeightItemList.length,
              (index) {
                SixtyeightItemModel model = provider
                    .createcompetitionchallengeModelObj
                    .sixtyeightItemList[index];
