import 'models/competitionleague_three_model.dart';
import 'package:flutter/material.dart';
import 'package:invovision_s_application1/core/app_export.dart';
import 'package:invovision_s_application1/widgets/custom_elevated_button.dart';
import 'provider/competitionleague_three_provider.dart';

// ignore_for_file: must_be_immutable
class CompetitionleagueThreePage extends StatefulWidget {
  const CompetitionleagueThreePage({Key? key})
      : super(
          key: key,
        );

  @override
  CompetitionleagueThreePageState createState() =>
      CompetitionleagueThreePageState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompetitionleagueThreeProvider(),
      child: CompetitionleagueThreePage(),
    );
  }
}

class CompetitionleagueThreePageState extends State<CompetitionleagueThreePage>
    with AutomaticKeepAliveClientMixin<CompetitionleagueThreePage> {
  @override
