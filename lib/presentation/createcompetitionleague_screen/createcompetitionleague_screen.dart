import '../createcompetitionleague_screen/widgets/fifteen2_item_widget.dart';
import 'models/createcompetitionleague_model.dart';
...
import 'provider/createcompetitionleague_provider.dart';

class CreatecompetitionleagueScreen extends StatefulWidget {
  const CreatecompetitionleagueScreen({Key? key})
      : super(
          key: key,
        );

  @override
  CreatecompetitionleagueScreenState createState() =>
      CreatecompetitionleagueScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CreatecompetitionleagueProvider(),
      child: CreatecompetitionleagueScreen(),
    );
  }
}

class CreatecompetitionleagueScreenState
    extends State<CreatecompetitionleagueScreen> {
  ...
  Widget _buildFifteen(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Consumer<CreatecompetitionleagueProvider>(
          builder: (context, provider, child) {
            return ListView.separated(
              ...
              itemCount: provider
                  .createcompetitionleagueModelObj.fifteen2ItemList.length,
              itemBuilder: (context, index) {
                Fifteen2ItemModel model = provider
                    .createcompetitionleagueModelObj.fifteen2ItemList[index];
                return Fifteen2ItemWidget(
                  model,
                );
              },
            );
  ...
  Widget _buildName(BuildContext context) {
    return Expanded(
      child: Padding(
        ...
        child:
            Selector<CreatecompetitionleagueProvider, TextEditingController?>(
          selector: (
            context,
            provider,
          ) =>
  ...
  Widget _buildEnterprizes(BuildContext context) {
    return Selector<CreatecompetitionleagueProvider, TextEditingController?>(
      selector: (
        context,
        provider,
      ) =>
